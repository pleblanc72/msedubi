...
IF EXISTS (select top 1 1 from [MLOutput].[StudentDropClass_rx])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping unnamed constraint on [MLOutput].[StudentDropClass_rx]...';


GO
ALTER TABLE [MLOutput].[StudentDropClass_rx] DROP CONSTRAINT [DF__StudentDr__Creat__02FC7413];


GO
PRINT N'Starting rebuilding table [MLOutput].[StudentDropClass_rx]...';
...
CREATE TABLE [MLOutput].[tmp_ms_xx_StudentDropClass_rx] (
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [MLOutput].[tmp_ms_xx_StudentDropClass_rx] ([StudentID], [TermID], [SubjectID], [CatalogID], [ClassID], [SectionID], [EnrollDate], [DropoutFlag], [RiskCategory], [CreationDate])
        SELECT [StudentID],
               [TermID],
               [SubjectID],
               [CatalogID],
...
DROP TABLE [MLOutput].[StudentDropClass_rx];

EXECUTE sp_rename N'[MLOutput].[tmp_ms_xx_StudentDropClass_rx]', N'StudentDropClass_rx';
