...
GO
PRINT N'Creating [MLOutput].[StudentDropClass_rx]...';
...
GO
PRINT N'Creating unnamed constraint on [MLOutput].[StudentDropClass_rx]...';


GO
ALTER TABLE [MLOutput].[StudentDropClass_rx]
