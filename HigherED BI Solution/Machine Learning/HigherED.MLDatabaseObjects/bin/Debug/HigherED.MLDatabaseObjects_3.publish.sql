...
GO
PRINT N'Creating [MLInput].[TrainedModels]...';
...
CREATE TABLE [MLInput].[TrainedModels] (
    ...
    PRIMARY KEY CLUSTERED ([Model_Name] ASC)
);


GO
PRINT N'Creating unnamed constraint on [MLInput].[TrainedModels]...';


GO
ALTER TABLE [MLInput].[TrainedModels]
    ADD DEFAULT ('default model') FOR [Model_Name];
