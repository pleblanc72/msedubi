...
GO
PRINT N'Creating [MLOutput].[StudentDropClass_rxLinMod]...';


GO
CREATE TABLE [MLOutput].[StudentDropClass_rxLinMod] (
    ...
    [DropoutProbability] FLOAT (53)   NULL,
...
GO
PRINT N'Creating unnamed constraint on [MLOutput].[StudentDropClass_rxLinMod]...';


GO
ALTER TABLE [MLOutput].[StudentDropClass_rxLinMod]
