...
GO
/*
The column [MLOutput].[StudentDropClass_rxLinMod].[DropoutProbability] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [MLOutput].[StudentDropClass_rxLinMod])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping unnamed constraint on [MLOutput].[StudentDropClass_rxLinMod]...';


GO
ALTER TABLE [MLOutput].[StudentDropClass_rxLinMod] DROP CONSTRAINT [DF__StudentDr__Creat__778AC167];


GO
PRINT N'Starting rebuilding table [MLOutput].[StudentDropClass_rxLinMod]...';
...
CREATE TABLE [MLOutput].[tmp_ms_xx_StudentDropClass_rxLinMod] (
    ...
    [DropoutLowerConfidence] FLOAT (53)   NULL,
    [DropoutUpperConfidence] FLOAT (53)   NULL,
    [RiskCategory]           VARCHAR (16) NULL,
    [CreationDate]           DATE         DEFAULT GETDATE() NULL
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [MLOutput].[StudentDropClass_rxLinMod])
    BEGIN
        INSERT INTO [MLOutput].[tmp_ms_xx_StudentDropClass_rxLinMod] ([StudentID], [TermID], [SubjectID], [CatalogID], [ClassID], [SectionID], [EnrollDate], [DropoutFlag], [RiskCategory], [CreationDate])
        SELECT [StudentID],
               [TermID],
               [SubjectID],
               [CatalogID],
...
DROP TABLE [MLOutput].[StudentDropClass_rxLinMod];

EXECUTE sp_rename N'[MLOutput].[tmp_ms_xx_StudentDropClass_rxLinMod]', N'StudentDropClass_rxLinMod';
